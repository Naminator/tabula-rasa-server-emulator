...
namespace TRE.GameService
{
    ...
    internal struct EquipmentClassSlot
    {
        internal int classId, slotId;
    }
    ...
    internal class ItemTemplate
    {
        ...
        internal string type; // ItemTemplateType type;
        internal int buybackPrice;
        internal string req1;
    }

    internal class GameData
    {
        //const int ITEMTYPE_WEAPON = 1, ITEMTYPE_ARMOR = 2;
        internal static List<ItemTemplate> ItemTemplates;
        internal static List<EquipmentClassSlot> equipmentClassSlots;
        internal static Hashtable starterItemTemplateClassIds;
        internal static List<MapInfo> mapInfoArray;
